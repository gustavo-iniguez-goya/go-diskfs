...
//
// mbr.Table implements the Table interface in github.com/gustavo-iniguez-goya/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/gustavo-iniguez-goya/go-diskfs package,
